...
from _reversa_sdd.reconstruction.editais_br_interfaces import (
    IEditalService,
    ISessionManager,
    IExtractor,
    ISearchEngine,
...
from _reversa_sdd.reconstruction.editais_br_html_extractor import HTMLExtractor
from _reversa_sdd.reconstruction.editais_br_pdf_extractor import PDFExtractor
...
def _edital_to_result(e: Any) -> EditalResult:
    ...
    return EditalResult(
        id=str(e.id),
        titulo=e.titulo,
        financiador=e.financiador or e.financiador or "",
