...
def split_description(content: str) -> Optional[PaperDetailDescription]:
 ...
 # test case1: {"doi": '10.1109/ACC.1999.786344'}, authors
 # test case2: {"doi": "10.1016/j.biopha.2019.109317"} authors, title, publisher, doi
 pattern = re.compile(
...
if __name__ == '__main__':
 ...
 translated_str = translate("", proxy=proxies)
